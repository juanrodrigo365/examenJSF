...
public class EjemploManagedBean {
	...
	public EjemploManagedBean(){
		...
		productos.add(new Producto(1, "Queso01", 9.5, "queso.jpg", 5));
		productos.add(new Producto(2, "Atún01", 12.0, "atun.jpg", 20));
		productos.add(new Producto(3, "Laptop01", 4500.0, "comp01.jpg", 3));
	}
